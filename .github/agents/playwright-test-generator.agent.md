...
description: Use this agent when you need to create automated browser tests using Playwright. Example usage and context can be included in the description field if needed.
tools:
  - search
